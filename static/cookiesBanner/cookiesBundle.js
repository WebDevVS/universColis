// --- Début : silktide-consent-manager.js ---
...
class SilktideCookieBanner {
    ...
    getModalContent() {
      ...
      <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        const savePreferencesButtonText = this.config.text?.preferences?.savePreferencesButtonText || 'Enregistrer mes choix';
        const savePreferencesButton = `<button class="preferences-save st-button st-button--primary">${savePreferencesButtonText}</button>`;
    ...
    setupEventListeners() {
        ...
        if (this.modal) {
            ...
            savePreferencesButton?.addEventListener('click', () => {
                this.setInitialCookieChoiceMade();
                this.updateCheckboxState(true); // Enregistre les choix personnalisés
                this.toggleModal(false);
                this.removeBanner();
                this.hideBackdrop();
                this.showCookieIcon();
...
(function () {
    ...
    window.silktideCookieBannerManager.showPreferences = function () {
        if (typeof cookieBanner?.toggleModal === 'function') {
...
// --- Fin : silktide-consent-manager.js ---

// --- Début : cookiesConfig.js ---
...
// --- Fin : cookiesConfig.js ---

// --- Début : cookiePreferencesButton.js ---
(function () {
...
// --- Fin : cookiePreferencesButton.js ---
